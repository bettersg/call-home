...
const SERVICE_CARD_DETAILS: ServiceCardDetailWithCategories[] = [
  {
    ...
    categories: [
      searchCategories.EMPLOYMENT_ISSUE,
      searchCategories.FOOD_WELFARE,
      searchCategories.LEGAL_AID,
      searchCategories.SALARY_CLAIM,
    ],
  },
  {
  ...
  },
  {
    ...
    name: 'HealthServe',
    shortBlurb:
      'Access healthcare services and call our 24-hour helpline for mental health support',
    route: ServicePath.HealthServe,
    categories: [
      searchCategories.MEDICAL_SERVICES,
      searchCategories.PHYSICAL_INJURY,
      searchCategories.MENTAL_HEALTH,
    ],
  },
  {
    ...
    name: 'Aidha',
    shortBlurb:
      'Learn how to manage your money, use computers, communicate with confidence, and more',
  ...
  },
  {
    ...
    categories: [
      ...
      searchCategories.EMPLOYMENT_ISSUE,
      searchCategories.FOOD_WELFARE,
      searchCategories.SKILLS_LEARNING,
    ],
  },
  {
    ...
    shortBlurb:
      'Call our 24-hour helpline for work problems, and check out our events!',
  ...
  },
  {
    ...
    shortBlurb:
      'Access social services, clubhouse facilities, and training courses',
  ...
  },
  {
    ...
    shortBlurb: 'Call us if you are hurt and need a ride or any assistance',
...
export function getServiceCardDetails(
  queryString: string[]
): ServiceCardDetail[] {
  if (queryString.length == 0) {
    return SERVICE_CARD_DETAILS;
  }
  return SERVICE_CARD_DETAILS.filter(
    (x) => x.categories.filter((y) => queryString.includes(y)).length >= 1
  );
}
